...
volatile unsigned int* led = (unsigned int*) XPAR_AXI_GPIO_STRIP_BASEADDR;
volatile unsigned int* led_color = (unsigned int*) XPAR_AXI_GPIO_LED_COLOR_BASEADDR;
/* ------------------------------------------------------------ */
...
void DemoPrintMenu()
{
	...
	xil_printf("9 - Change LED Strip Color\n\r");
	xil_printf("0 - Turn LED strip ON/OFF\n\r");
	xil_printf("q - Quit\n\r");
	xil_printf("led color: %d\n\r", *led_color);
	xil_printf("\n\r");
...
void DemoCLEDMenu()
{
	...
	xil_printf("\x1B[2J"); //Clear terminal
	xil_printf("**************************************************\n\r");
	xil_printf("*             WS2812B LED Strip Demo              *\n\r");
	xil_printf("**************************************************\n\r");
	xil_printf("\n\r");
	xil_printf("1 - Ambient\n\r");
	xil_printf("2 - White\n\r");
	xil_printf("3 - Red\n\r");
	xil_printf("4 - Green\n\r");
	xil_printf("5 - Blue\n\r");
	xil_printf("q - Quit (don't change color)\n\r");
	xil_printf("\n\r");
	xil_printf("Select a new color for LED:");
}
void DemoChangeRes()
{
	int fResSet = 0;
	...
	while (!fResSet)
	{
		...
		case '6':
			status = DisplayStop(&dispCtrl);
			DisplaySetMode(&dispCtrl, &VMODE_1024x768);
			DisplayStart(&dispCtrl);
			fResSet = 1;
			break;
		case 'q':
