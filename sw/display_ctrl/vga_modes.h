...
static const VideoMode VMODE_1024x768 = {
	...
	.width = 1024,
	.height = 768,
	.hps = 1048,  // Horizontal sync starts 24 pixels after the active video (1024 + 24)
	.hpe = 1184,  // Horizontal sync ends at 1184 (giving a sync pulse width of 136 pixels)
	.hmax = 1343, // Total horizontal period is 1344 pixels (0 to 1343)
	.hpol = 1,    // Positive horizontal sync polarity
	.vps = 771,   // Vertical sync starts 3 lines after the active video (768 + 3)
	.vpe = 777,   // Vertical sync ends at 777 (sync pulse width of 6 lines)
	.vmax = 805,  // Total vertical period is 806 lines (0 to 805)
	.vpol = 1,    // Positive vertical sync polarity
	.freq = 65.0  // Pixel clock frequency is 65.0 MHz
};
